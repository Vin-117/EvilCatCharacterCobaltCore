...
/// 
public class EvilCatFullMemoryAccessStatusManager : IKokoroApi.IV2.IStatusLogicApi.IHook, IKokoroApi.IV2.IStatusRenderingApi.IHook
{

    /// 
    /// Register hooks
    /// 
    public EvilCatFullMemoryAccessStatusManager() 
    {
